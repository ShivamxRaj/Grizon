    ...
    async def event_generator():
        ...
        if is_greeting:
            system_prompt = (
                ...
                "Respond warmly, politely, and concisely in the exact same language/style as the user (e.g. Hinglish, English, Hindi, Tamil, etc.). "
                "Greet them back naturally (e.g. 'Hello! Main badhiya hoon. Aap bataiye, aap kis legal case, IPC/BNS section, ya dispute ke baare mein jaanna chahte hain?') "
            ...
            system_prompt = (
                ...
                "DYNAMIC LANGUAGE RULE: Detect the language and style of the user's query (e.g., Hinglish, Hindi in Devanagari, "
                "Tamil, Bengali, Marathi, Gujarati, etc.) and write the entire explanation in the exact same regional language "
                "and script/transliteration style. If the user asks in Hinglish, reply in Hinglish. If they ask in Tamil, reply in Tamil. "
